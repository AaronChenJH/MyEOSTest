...
void UCommonUserSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	// Create our OSS wrappers, 初始化设置了IOnlineSubsystem OnlineSubsystem 和 IOnlineIdentityPtr Identity = OnlineSubsystem->GetIdentityInterface()
	...
	UE_LOG(LogTemp, Warning, TEXT("CommonUserModule UCommonUserSubsystem Initialize"));
...
void UCommonUserSubsystem::Deinitialize()
{
	...
	UE_LOG(LogTemp, Warning, TEXT("CommonUserModule UCommonUserSubsystem Deinitialize"));
...
bool UCommonUserSubsystem::ShouldCreateSubsystem(UObject* Outer) const
{
	...
	UE_LOG(LogTemp, Warning, TEXT("CommonUserModule UCommonUserSubsystem ShouldCreateSubsystem"));
...
{
	// ServiceType 类似于EOS自身的Server，PlatformType 类似于诸如steam等其他账户的登入
